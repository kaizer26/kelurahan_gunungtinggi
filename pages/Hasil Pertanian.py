...
st.dataframe(lahan23,use_container_width=True)
st.dataframe(pt23)

#this is content
st.write("# Fasilitas Pendidikan")
pd1,pd2,pd3,pd4,pd5 = st.columns((1,1,1,1,1))
pd1.metric(label='TK',value=str(int(fas23.iloc[1,1]+fas23.iloc[13,1])))
pd2.metric(label='SD',value=str(int(fas23.iloc[2,1]+fas23.iloc[14,1])))
pd3.metric(label='SMP',value=str(int(fas23.iloc[3,1]+fas23.iloc[15,1])))
pd4.metric(label='SMA',value=str(int(fas23.iloc[4,1]+fas23.iloc[16,1])))
pd5.metric(label='PT',value=str(int(fas23.iloc[5,1]+fas23.iloc[17,1])))
...
ks4.metric(label='Prak. Dokter',value=str(int(fas23.iloc[30,1])))
ks5.metric(label='Prak. Bidan',value=str(int(fas23.iloc[34,1])))
...
ag6.metric(label='Pura',value=str(int(fas23.iloc[91,1])))
ag7.metric(label='Klenteng',value=str(int(fas23.iloc[92,1])))
...
pb4.metric(label='Pegadaian',value=str(int(fas23.iloc[44,1])))
...
pg1.metric(label='Toko/Kios',value=str(int(fas23.iloc[50,1])))
